...
export function Navbar() {
  ...
  return (
    <nav className="border-b bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60 sticky top-0 z-50 animate-fade-down">
          ...
          <div className="hidden md:flex md:items-center md:space-x-4 md:absolute md:left-1/2 md:transform md:-translate-x-1/2">
            {navigation.map((item) => (
              <Link
                ...
                href={item.href}
                className={cn(
                  "px-3 py-2 text-sm font-medium rounded-md transition-all duration-300 hover:scale-105",
                  pathname === item.href
          ...
          <div className="md:hidden py-4 border-t animate-slide-down">
            <div className="flex flex-col space-y-2">
              ...
              <div className="pt-4 border-t mt-2 flex flex-col space-y-2">
                <Button variant="ghost" asChild className="w-full justify-start transition-all duration-300">
