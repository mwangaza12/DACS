...
export const getDoctorByIdController = async (req: Request, res: Response) => {
    const {id}  = req.params;;
    const doctor = await getDoctorByIdService(String(id));
...
export const getDoctorAvailabilityController = async (req: Request, res: Response) => {
    const {id}  = req.params;;
    const availability = await getDoctorAvailabilityService(String(id));
...
export const updateDoctorAvailabilityController = async (req: Request, res: Response) => {
    ...
    const updated = await upsertDoctorAvailabilityService(String(id), parsed.data);
